...
$query =
  "SELECT * FROM home,section_control,social_media,about,contact,site_background,seo,admin,cv";
...
<head>
  ...
  <title>Admin Panel | Pranto Kumar Saha</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <a href="index.php?uploadresume=true" class="nav-link">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
                ...
                <form role="form" action="../include/admin.php" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-check">
                      <input type="checkbox" name="showicons" class="form-check-input" id="exampleCheck1" <?php if ($user_data["showicons"]) {
                                                                                                            echo "checked";
                                                                                                          } ?>>
            ...
            <?php } elseif (isset($_GET["aboutsetting"])) { ?>
              <div class="card card-primary col-lg-12">
                <div class="card-header">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <img src="../images/<?= $user_data["profile_pic"] ?>" style="height: 100px;width:100px;">
                <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea cols="50" name="aboutdesc" class="form-control"><?= $user_data["about_desc"] ?></textarea>
                    </div>
                  </div>
                  <!-- /.card-body -->
            ...
            <?php } elseif (isset($_GET["resumesetting"])) { ?>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        while ($pi = mysqli_fetch_array($r)) { ?>
                          <tr>
                            <td><?= $c ?></td>
                            <td><?= $pi["resume_type"] ?></td>
                            <td><?= $pi["title"] ?></td>
                            <td><?= $pi["resume_time"] ?></td>
                            <td><?= $pi["org"] ?></td>
                            <td><?= $pi["about_exp"] ?></td>
                            <td><?= $pi["official_website_link"] ?></td>
                            <td>
                ...
                <form role="form" action="../include/admin.php" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" name="official_website_link" id="exampleInputEmail1">
                    </div>
            ...
            <?php } elseif (isset($_GET["portfoliosetting"])) { ?>
              <div class="card card-primary col-lg-12">
                <div class="card-header">
            ...
            <?php } elseif (isset($_GET["contactsetting"])) { ?>
              <div class="card card-primary col-lg-12">
                <div class="card-header">
            ...
            <?php } elseif (isset($_GET["changebackground"])) { ?>
              <div class="card card-primary col-lg-12">
                <div class="card-header">
            ...
            <?php } elseif (isset($_GET["accountsetting"])) { ?>
              <div class="card card-primary col-lg-12">
                <div class="card-header">
            ...
            <?php } elseif (isset($_GET["uploadresume"])) { ?>
              <div class="card card-primary col-lg-12">
                <div class="card-header">
                ...
                <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                  ...
                  <p class="col-6">Uploaded CV/Resume : <?= $user_data["cv_file"] ?></p>
                  <!-- /.card-body -->

                  <div class="card-footer">
                    <button type="submit" name="update-resume" class="btn btn-primary">Update Resume</button>
                  </div>
                </form>
              </div>
            ...
            <?php } else { ?>
              ...
              <form method="post" action="../include/admin.php">
                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                  <input type="checkbox" name="home" class="custom-control-input" id="customSwitch1" <?php if ($user_data["home_section"]) {
                                                                                                        echo "checked";
                                                                                                      } ?>>
                ...
                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                  <input type="checkbox" name="about" class="custom-control-input" id="customSwitch2" <?php if ($user_data["about_section"]) {
                                                                                                        echo "checked";
                                                                                                      } ?>>
                ...
                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                  <input type="checkbox" name="resume" class="custom-control-input" id="customSwitch3" <?php if ($user_data["resume_section"]) {
                                                                                                          echo "checked";
                                                                                                        } ?>>
                ...
                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                  <input type="checkbox" name="portfolio" class="custom-control-input" id="customSwitch4" <?php if ($user_data["portfolio_section"]) {
                                                                                                            echo "checked";
                                                                                                          } ?>>
                ...
                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                  <input type="checkbox" name="contact" class="custom-control-input" id="customSwitch5" <?php if ($user_data["contact_section"]) {
                                                                                                          echo "checked";
                                                                                                        } ?>>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="javascript:void(0);">Pranto Kumar Saha</a>.</strong>
      All rights reserved.
